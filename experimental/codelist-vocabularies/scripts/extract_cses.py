...
ont_dir = Path(__file__).parent.parent.parent.parent / "isotc211_GOM_harmonizedOntology" / "iso19115" / "-1" / "2018"
voc_dir = Path(__file__).parent.parent.parent.parent / "experimental" / "codelist-vocabularies" / "iso19115" / "-1" / "2018"
